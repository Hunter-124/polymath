...
| Wave Z complete | ✅ green | **46** tools; ORT CUDA; auto-update; IMAP; enroll UI; AEC-lite; **signed** 0.3.2 installer; tag `v0.3.2-complete` |
| Wave Z installer | ✅ green | `Polymath-0.3.2-win64-cuda-Setup.exe` (self-signed + timestamped) |
...
| **Tools** | **46** (+ `fs_undo`, `calendar_read`, `inbox_notes`, `email_fetch`) |
| **Wave Z complete** | CUDA ORT package; adaptive barge-in; face enroll UI; auto-update; signed installer 0.3.2 |
