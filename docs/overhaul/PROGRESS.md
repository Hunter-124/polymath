...
- B1â€“B9: QML packages landed; C1 wires Main.qml (palette/toasts/bell/surfaces/Style bindings).
- C1: Main.qml palette registry+Ctrl+K, ToastStack, Bell+Center, SurfaceHost, Styleâ†”settings Bindings; openSettings(section).
