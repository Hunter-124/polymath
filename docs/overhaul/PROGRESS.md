...
Legend: [ ] pending ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· [~] in progress ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· [x] done ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· [!] blocked (see docs/overhaul/results/)

## Wave A ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â foundations
...
## Wave B ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â GUI packages (parallel after A2)
...
## Wave C ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â harness features
...
## Wave D ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â verify & ship
...
- [ ] D5 (optional) QtWebEngine + real WebSurface ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â awaiting owner go-ahead
