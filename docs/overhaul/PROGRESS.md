...
Legend: [ ] pending Ã‚Â· [~] in progress Ã‚Â· [x] done Ã‚Â· [!] blocked (see docs/overhaul/results/)

## Wave A Ã¢â‚¬â€ foundations
...
## Wave B Ã¢â‚¬â€ GUI packages (parallel after A2)
...
- [ ] D5 (optional) QtWebEngine + real WebSurface Ã¢â‚¬â€ awaiting owner go-ahead

## Notes / deviations
- BV: capture 13/13 both modes; SettingsView onCompleted, PmTooltip hover, ModelManager radius, Dashboard taskCount.
- A3: schema v2 goals/plan_steps; ToolContext.memory; task scheduler tool dispatch; taskFinishedÃ¢â€ â€™notice/chat; countTokens; n_ctx 4096; KV q8_0.
...
- B1Ã¢â‚¬â€œB9: QML packages landed; C1 still owns Main.qml feature wiring (palette/toasts/bell/surfaces/Style bindings).
